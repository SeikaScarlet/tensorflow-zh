...
\documentclass[b5paper,10pt,twoside]{ctexbook}
...
\definecolor{codeback}{rgb}{0.94,0.98,0.99}
\definecolor{etc}{rgb}{0.7,0.66,0.61}
...
\lstset{ %
  ...
  basicstyle=\linespread{0.95}\scriptsize\CodeFont,   % the size of the fonts that are used for the code
...
\include{tutorials/c2s03_tf_101}
